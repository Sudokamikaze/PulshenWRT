...
case "$item" in
  ...
  cd tmp && git clone https://github.com/Sudokamikaze/PulshenWRT_BB.git
  echo Applying patches
  cp -r PulshenWRT_BB/files ../build_dir/bb_wrt/
  cd ../build_dir/bb_wrt && patch < ../../tmp/PulshenWRT_BB/PulshenWRT_BB.diff
  ;;
